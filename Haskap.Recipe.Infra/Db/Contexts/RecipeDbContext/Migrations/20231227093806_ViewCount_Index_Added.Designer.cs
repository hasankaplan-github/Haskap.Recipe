...
namespace Haskap.Recipe.Infra.Db.Contexts.RecipeDbContext.Migrations
{
    ...
    [Migration("20231227093806_ViewCount_Index_Added")]
    partial class ViewCount_Index_Added
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Haskap.Recipe.Domain.RecipeAggregate.Recipe", b =>
                {
                    ...
                    b.HasIndex("ViewCount")
                        .HasDatabaseName("ix_recipe_view_count");
            ...
            modelBuilder.Entity("Haskap.Recipe.Domain.RecipeAggregate.Recipe", b =>
                {
                    b.OwnsOne("Haskap.Recipe.Domain.Common.File", "Picture", b1 =>
                        {
            ...
            modelBuilder.Entity("Haskap.Recipe.Domain.UserAggregate.UserRole", b =>
                {
                    b.HasOne("Haskap.Recipe.Domain.RoleAggregate.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
